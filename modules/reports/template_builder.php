...
<div class="studio-header">
    <div class="d-flex align-items-center gap-3">
        <a href="index.php" class="btn btn-light rounded-pill px-3 shadow-sm"><i class="bi bi-chevron-left me-1"></i>
            Studio</a>
    ...
    <div>
        ...
        <button id="master-action" class="btn btn-indigo shadow-md px-4">NEXT STEP <i
        ...
        <div class="centered-content">
            <div class="container maxWidth-md" style="max-width: 900px;">
                <!-- <div class="mb-5 text-center">
                    <h2 class="fw-500 text-dark">Data Foundation</h2>
                ...
                <div class="row g-4">
                    <div class="col-md-5">
                        <div class="card border-0 shadow-sm  p-4 h-100">
                            <h6 class="fw-500 mb-4 opacity-50"><i class="bi bi-shield-check me-2"></i> IDENTITY</h6>
                            <div class="mb-4">
                                <label class="text-xs fw-500 text-muted text-uppercase d-block mb-1">Template Branding
                                    Name</label>
                                <input type="text" id="template-name" class="form-control form-control-md bg-light "
                                    value="<?php echo $saved_name; ?>" placeholder="e.g. Executive Invoice Platinum">
                            </div>

                            <div class="mb-4">
                                <label class="text-xs fw-500 text-muted text-uppercase d-block mb-1">Primary Data Source
                                    (Root)</label>
                                <select id="prime-module" class="form-select form-select-md bg-light ">
                    ...
                    <div class="col-md-7">
                        <div class="card border-0 shadow-sm  p-4 h-100 bg-white">
                            <div class="d-flex justify-content-between align-items-start mb-4">
                                <h6 class="fw-500 opacity-50"><i class="bi bi-diagram-3-fill me-2"></i> MAP RELATIONS
                                </h6>
                                <button class="btn btn-sm btn-light rounded-pill border fw-700"
                                    onclick="openConnectionModal()">+ Add Relation</button>
                            </div>
    ...
    <div id="pane-2" class="wizard-pane d-none">
        <div class="painter-sidebar shadow-sm">
            <div class="p-4 border-bottom">
                <h6 class="fw-500 m-0">Studio Tokens</h6>
                <p class="text-xxs text-muted m-0">Click tokens to bind them into your design.</p>
            </div>
            <div class="p-3">
                <div class="input-group input-group-sm mb-3">
                    <span class="input-group-text bg-white border-0 shadow-sm rounded-start-3"><i
                            class="bi bi-search"></i></span>
                    <input type="text" id="token-search" class="form-control border-0 shadow-sm rounded-end-3"
        ...
        <div class="painter-main">
            <div class="editor-toolbar">
                <div class="d-flex gap-2">
                    <button class="btn btn-sm btn-light border rounded-pill fw-700 px-3"
                        onclick="loadPreset('invoice')"><i class="bi bi-file-earmark-text me-1"></i> Invoice</button>
                    <button class="btn btn-sm btn-light border rounded-pill fw-700 px-3"
                        onclick="loadPreset('receipt')"><i class="bi bi-receipt me-1"></i> Receipt</button>
                    <button class="btn btn-sm btn-light border rounded-pill fw-700 px-3"
                        onclick="loadPreset('clean')"><i class="bi bi-stars me-1"></i> Clean Canvas</button>
                </div>
                <div class="h-divider mx-2 opacity-25"></div>
                <div class="text-xs fw-500 opacity-50">EDITOR: PAINTER MODE (HTML5 / CSS3)</div>
                <div class="ms-auto d-flex align-items-center gap-3">
                    <span class="text-xxs fw-500 text-muted"><i class="bi bi-keyboard text-primary me-1"></i> ACE ATOM
                        READY</span>
                </div>
            </div>
    ...
    <div id="pane-3" class="wizard-pane d-none">
        <div class="painter-sidebar shadow-sm border-end">
            <div class="p-4 bg-light border-bottom">
                <h6 class="fw-500 m-0">QA Controls</h6>
                <p class="text-xxs text-muted m-0">Live data preview with latest records.</p>
            </div>
            <div class="p-4">
                <div class="card bg-indigo text-white border-0  p-4 mb-4 shadow-md"
                    style="background: linear-gradient(135deg, #4f46e5, #6366f1);">
                    <h3 class="fw-500 mb-1">Live Mode</h3>
                    <p class="text-xs opacity-75">All tokens are now replaced with real database records for validation.
                    </p>
                </div>
        ...
        <div class="centered-content d-flex align-items-center">
            <div class="deploy-card text-center">
                <div class="mb-5">
                    ...
                    <h2 class="fw-500">Ready for Launch?</h2>
                ...
                <div class="p-4 bg-light  mb-5 border text-start">
                    <h6 class="fw-500 text-xs mb-3 text-uppercase opacity-50">FINAL CHECKLIST</h6>
                    <div class="d-flex gap-3 mb-3">
                        <i class="bi bi-check-circle-fill text-success"></i>
                        <div>
                            <div class="text-sm fw-500">Template Logic Bound</div>
                    ...
                    <div class="d-flex gap-3">
                        <i class="bi bi-check-circle-fill text-success"></i>
                        <div>
                            <div class="text-sm fw-500">Performance Tuned</div>
                            <p class="text-xxs text-muted m-0">Optimized HTML markup and CSS structures.</p>
                        </div>
                    </div>
                </div>

                <button id="final-deploy" class="btn btn-indigo btn-md w-100 rounded-pill py-3 fw-500 shadow-xl">DEPLOY
                    DESIGN LIVE</button>
                <button class="btn btn-link text-muted fw-700 mt-3 text-decoration-none exit-studio"
                    onclick="location.href='index.php'">Cancel & Discard</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-content-glass shadow-xxl border-0">
            <div class="modal-header border-0 pb-0 px-4 pt-4">
                <h5 class="fw-500 m-0"><i class="bi bi-diagram-3-fill me-2 text-primary"></i> Link Relation</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-4">
                <div class="mb-4">
                    <label class="text-xs fw-500 text-uppercase text-muted d-block mb-1">Child Table (Related
                        Module)</label>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <label class="text-xs fw-500 text-uppercase d-block mb-1">Primary key</label>
                    ...
                    <div class="col-6">
                        <label class="text-xs fw-500 text-uppercase d-block mb-1">Foreign Key</label>
                        <div id="rel-child-fields-wrapper">
                            <select id="rel-cfield" class="form-select border-0 bg-light rounded-3 fw-700 text-xs"
                                disabled>
                ...
                <div class="p-3 bg-white bg-opacity-50  border border-dashed text-center">
                    <i class="bi bi-shield-check text-indigo me-1"></i>
                    <span class="text-xs fw-500">Enables dynamic loop <code
                            class='text-indigo'>{{#collection}}</code></span>
                </div>
            </div>
            <div class="modal-footer border-0 p-4 pt-0">
                <button class="btn btn-indigo w-100 rounded-pill py-3 fw-500" onclick="addRelation()">Link Now</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        ...
        try {
            let dcRaw = <?php echo json_encode($saved_connections); ?>;
            window.dataRelations = (typeof dcRaw === 'string') ? JSON.parse(dcRaw || '[]') : (dcRaw || []);
        } catch (e) { 
            console.error("Failed to parse data relationships:", e);
            window.dataRelations = []; 
        }
            ...
            <div class="col-12">
                <div class="rel-card shadow-sm h-100">
                    ...
                    <div class="d-flex align-items-center gap-3">
                         ...
                         <div>
                              <h6 class="fw-500 mb-1">${rel.mname.toUpperCase()} (LINKED)</h6>
                              <div class="text-xs opacity-75">Connects via <span class="fw-500">${rel.pfield}</span> to <span class="fw-500">${rel.clabel}</span></div>
                         </div>
                    </div>
                </div>
            </div>`;
        ...
        async function loadTokens() {
            ...
            let systemHtml = '<div class="mb-4"><h6 class="text-xxs fw-500 opacity-50 px-2 mb-2">SYSTEM TOKENS</h6>';
            ...
            try {
                ...
                if (res.status === 'success') {
                    let primaryHtml = `<div class="mb-4"><h6 class="text-xxs fw-500 opacity-50 px-2 mb-2">${mname.toUpperCase()} DATA</h6>`;
                    res.data.forEach(f => {
            ...
            if (window.dataRelations.length > 0) {
                let loopHtml = '<div class="mb-4"><h6 class="text-xxs fw-500 opacity-50 px-2 mb-2 text-indigo">COLLECTIONS (LOOPS)</h6>';
                ...
                for (const rel of window.dataRelations) {
                    try {
                        ...
                        if (res.status === 'success') {
                            let relHtml = `<div class="mb-4"><h6 class="text-xxs fw-500 opacity-50 px-2 mb-2 text-primary">${rel.mname.toUpperCase()} FIELDS</h6>`;
                            res.data.forEach(f => {
                                const cleanName = (f.field_name || f.field_label).toLowerCase().replace(/[^a-z0-9]+/g, '_');
        ...
        function renderLivePreview() {
            ...
            window.dataRelations.forEach(rel => {
                ...
                html = html.replace(loopStart, `<div class="qa-loop-indicator text-xxs fw-500 text-indigo opacity-50 mb-2 border-bottom">LOOP: ${rel.mname.toUpperCase()} START</div>`);
                html = html.replace(loopEnd, `<div class="qa-loop-indicator text-xxs fw-500 text-indigo opacity-50 mt-2 border-top">LOOP: ${rel.mname.toUpperCase()} END</div>`);
            });
